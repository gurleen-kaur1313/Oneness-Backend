...
class Mutation(blog.schema.Mutation, protestId.schema.Query, ngo.schema.Mutation, emergency.schema.Mutation, resources.schema.Mutation, location.schema.Mutation, donations.schema.Mutation, graphene.ObjectType):
